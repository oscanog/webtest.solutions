...
const cfg = Object.freeze({
  ...
  apiBasePath: `/${readEnv("E2E_MOBILE_API_BASE_PATH", "/webtest/api/v1").replace(/^\/+/, "").replace(/\/+$/, "")}`,
  mobileRepoPath: readEnv("E2E_MOBILE_REPO_PATH", "C:\\projects\\school\\gendejesus\\webtest-mobileweb"),
